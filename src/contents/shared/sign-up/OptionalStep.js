...
export const OptionalStep = ({type, handleChange, locationPlaceholder, photographerType, showCustomSelect, showCustomSelectHandler, optionSelectHandler, loadingDB, successDB}) => (
  <Spring delay={100} from={{opacity: 0}} to={{opacity: 1}}>
    {props =>
      <div style={props}>
        <p className="small">Add your location and the type of photographer you are
          and search the best jobs opportunities</p>
        <LocationSearchInput
        ...
        <input type="submit" value="Skip this step" className="white-text-link"/>
        {
          loadingDB ?
            (<input type="submit"
                    value="Loading..."
