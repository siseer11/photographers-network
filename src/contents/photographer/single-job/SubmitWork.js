...
import {
  removeImgFromDBandStore,
  submitWork
} from "../../../redux/actions/single-job-action-photographer";
...
const mapDispatchToProps = dispatch => ({
  ...
  removeImgFromDBandStore: (jobId, id) =>
    dispatch(removeImgFromDBandStore(jobId, id))
});
  ...
  removeImages() {
    ...
    if (!submitted) {
      images.forEach(image => {
        this.props
          .removeImgFromDBandStore(this.state.jobId, image.id)
