...
export const SingleJobViewhotographer = ({user, userApplied, acceptedApplicant, isDeclinedPhotographer, applyHandler, jobId}) => (
  ...
  userApplied ? (
    ...
    acceptedApplicant !== "none" && acceptedApplicant.uid === user.uid ?
      ...
      </React.Fragment> : // user applied and has been accepted
