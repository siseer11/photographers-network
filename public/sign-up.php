...
<head>
    ...
    <title>Sign Up - Photography Network</title>
...
<div class='gb-app-wrapper'>
    ...
    <!-- sign up starts-->
    <div class="gb-gradient-red-black section-content with-padding">

        <div class="gb-page-content-center">
            <form class="gb-form-350" id="sign-up-form" onsubmit="signUp(event)">
                <h1 class="gb-margin-bottom-32">Sign up <span id="type"></span></h1>

                <div class='inputWrapper'>
                    <label class='inputLabel'>
                        <svg id="nameInput" viewBox="0 0 25 25" width="100%" height="100%"
                             class="gb-icon gb-icon-medium gb-icon-white inputIcon">
                            <title>name input</title>
                            <g>
                                <path d="M3 16H22" stroke-linecap="square"></path>
                                <path d="M3 9.5H16" stroke-linecap="square"></path>
                            </g>
                        </svg>

                        <input type="text" name="name" class="gb-text-input gb-text-input-trans-background"
                               placeholder="Name*"
                               required/>
                    </label>
                </div>
                ...
                <div class='inputWrapper'>
                    <label class='inputLabel'>
                        <svg id="email" viewBox="0 0 50 50" width="100%" height="100%"
                             class="gb-icon gb-icon-medium gb-icon-white inputIcon">

                            <title>email</title>
                            <g>
                                <path d="M1 4C1 2.34315 2.34315 1 4 1H36C37.6569 1 39 2.34315 39 4V30C39 31.6569 37.6569 33 36 33H4C2.34315 33 1 31.6569 1 30V4Z"
                                      transform="translate(5 8)" stroke-width="2" stroke-linecap="round"></path>
                                <path d="M35 0L17.5001 18L0 0" transform="translate(8 9)" stroke-width="2"></path>
                            </g>
                        </svg>

                        <input type="email" name="email" class="gb-text-input gb-text-input-trans-background"
                               placeholder="Email*"
                               required/>
                    </label>
                ...
                <div class='inputWrapper'>
                    <label class='inputLabel'>
                        <svg id="email" viewBox="0 0 44 52" width="100%" height="100%"
                             class="gb-icon gb-icon-medium gb-icon-white inputIcon">

                            <title>password</title>
                            <g>
                                <path d="M22 51C11.5066 51 3 42.4934 3 32C3 21.5066 11.5066 13 22 13C32.4934 13 41 21.5066 41 32C41 42.4934 32.4934 51 22 51Z"
                                      stroke-width="2" stroke-linecap="round"></path>
                                <path d="M26 32C26 34.2091 24.2091 36 22 36C19.7909 36 18 34.2091 18 32C18 29.7909 19.7909 28 22 28C24.2091 28 26 29.7909 26 32Z"
                                      stroke-width="2"></path>
                                <path d="M12 15V11.7794C12 6.38704 16.486 2 22 2C27.514 2 32 6.38704 32 11.7794V15"
                                      stroke-width="2"></path>
                            </g>
                        </svg>

                        <input type="password" name="password" class="gb-text-input gb-text-input-trans-background"
                ...
                <div class='inputWrapper'>
                    <label class='inputLabel'>
                        <svg id="password" viewBox="0 0 44 52" width="100%" height="100%"
                             class="gb-icon gb-icon-medium gb-icon-white inputIcon">
                        ...
                        <input type="password" name="password2" class="gb-text-input gb-text-input-trans-background"
                ...
                <div
                        class="custom-select gb-text-input gb-text-input-trans-background"
                        onclick="showCustomSelectHandler(event)"
                >
                    <svg id="business-card" style="display:none;" class="gb-icon gb-icon-medium gb-icon-white inputIcon" viewBox="0 0 24 24" width='100%'
                         height='100%'>
                        <title>business-card</title>
                        <path d="M20 20h-16c-1.654 0-3-1.346-3-3v-10c0-1.654 1.346-3 3-3h16c1.654 0 3 1.346 3 3v10c0 1.654-1.346 3-3 3zM4 6c-0.551 0-1 0.449-1 1v10c0 0.551 0.449 1 1 1h16c0.551 0 1-0.449 1-1v-10c0-0.551-0.449-1-1-1h-16z"></path>
                        <path d="M10 15h-4c-0.553 0-1-0.448-1-1s0.447-1 1-1h4c0.553 0 1 0.448 1 1s-0.447 1-1 1z"></path>
                        <path d="M10 11h-4c-0.553 0-1-0.448-1-1s0.447-1 1-1h4c0.553 0 1 0.448 1 1s-0.447 1-1 1z"></path>
                        <path d="M18 10.5c0 1.105-0.895 2-2 2s-2-0.895-2-2c0-1.105 0.895-2 2-2s2 0.895 2 2z"></path>
                        <path d="M16 13.356c-1.562 0-2.5 0.715-2.5 1.429 0 0.357 0.938 0.715 2.5 0.715 1.466 0 2.5-0.357 2.5-0.715 0-0.714-0.98-1.429-2.5-1.429z"></path>
                    </svg>
                    <svg id="camera" class="gb-icon gb-icon-medium gb-icon-fill-white inputIcon" viewBox="0 0 24 24" width="100%"
                         height="100%">
                        <title>camera</title>
                        <path d="M19 20h-14c-1.654 0-3-1.346-3-3v-8c0-1.654 1.346-3 3-3h1.586l1-1c0.579-0.579 1.596-1 2.414-1h4c0.818 0 1.835 0.421 2.414 1l1 1h1.586c1.654 0 3 1.346 3 3v8c0 1.654-1.346 3-3 3zM5 8c-0.552 0-1 0.448-1 1v8c0 0.552 0.448 1 1 1h14c0.552 0 1-0.448 1-1v-8c0-0.552-0.448-1-1-1h-2c-0.266 0-0.52-0.105-0.707-0.293l-1.293-1.293c-0.201-0.201-0.715-0.414-1-0.414h-4c-0.285 0-0.799 0.213-1 0.414l-1.293 1.293c-0.187 0.188-0.441 0.293-0.707 0.293h-2z"></path>
                        <path d="M12 10c1.379 0 2.5 1.121 2.5 2.5s-1.121 2.5-2.5 2.5-2.5-1.121-2.5-2.5 1.121-2.5 2.5-2.5zM12 9c-1.934 0-3.5 1.566-3.5 3.5 0 1.932 1.566 3.5 3.5 3.5s3.5-1.568 3.5-3.5c0-1.934-1.566-3.5-3.5-3.5z"></path>
                        <path d="M18 8.699c-0.719 0-1.3 0.582-1.3 1.301s0.581 1.299 1.3 1.299 1.3-0.58 1.3-1.299-0.581-1.301-1.3-1.301z"></path>
                    </svg>
                    <span id="select-type">photographer</span>
                    <svg id="icon-circle-down" viewBox="0 0 32 32" class="arrow-icon gb-icon gb-icon-medium gb-icon-fill-white inputIcon">
                        <title>circle-down</title>
                        <path d="M32 16c0-8.837-7.163-16-16-16s-16 7.163-16 16 7.163 16 16 16 16-7.163 16-16zM3 16c0-7.18 5.82-13 13-13s13 5.82 13 13-5.82 13-13 13-13-5.82-13-13z"></path>
                        <path d="M9.914 11.086l-2.829 2.829 8.914 8.914 8.914-8.914-2.828-2.828-6.086 6.086z"></path>
                    </svg>
                    <ul id="select-dropdown" class="custom-select-dropdown" style="display:none;">
                        <li onclick="optionSelectHandler('company')" class='custom-select-option'>company</li>
                        <li onclick="optionSelectHandler('photographer')" class='custom-select-option'>photographer</li>
                    </ul>
                </div>
                ...
                <div class="btn-container">
                    <input type="submit" value="Sign Up" class="gb-btn gb-btn-large gb-btn-primary"/>
                </div>
            </form>
        </div>
    </div>
...
<script src='scripts/config/Fire.js'></script>
<script type='text/javascript' src='scripts/navbar.js'></script>
<script type='text/javascript' src='scripts/sign-up.js'></script>
