...
<head>
    ...
    <title>Sign In - Photography Network</title>
...
<div class='gb-app-wrapper'>
    ...
    <div class="gb-gradient-red-black section-content with-padding">
        <div class="gb-page-content-center">
            <form class="gb-form-350" id="sign-in-form" onsubmit="signIn(event)">
                <h1 class="gb-margin-bottom-32">Sign In</h1>
                <div class='inputWrapper'>
                    <label class='inputLabel'>
                        <svg id="email" viewBox="0 0 50 50" width="100%" height="100%" class="gb-icon gb-icon-medium gb-icon-white inputIcon">
                            <title>email</title>
                            <g>
                        ...
                        <input type="email" name="email" class="gb-text-input gb-text-input-trans-background" placeholder="Email*"
                               required />
                    </label>
                </div>
                <div class='inputWrapper'>
                ...
                <div class="btn-container">
                    <input type="submit" value="Sign In" class="gb-btn gb-btn-large gb-btn-primary" />
                </div>
            </form>
        </div>
    </div>
